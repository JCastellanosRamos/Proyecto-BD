...
//Hacer la busqueda
	...
	$query ="SELECT idUsuario, Nombre, Ap_paterno, Ap_materno, Genero, Correo_electronico, Fecha_Nacimiento, Usuario, Contrasena, Tipo FROM Usuarios LEFT JOIN Tipos_usuario t USING(idTipo) WHERE Nombre = '$nombre'";
