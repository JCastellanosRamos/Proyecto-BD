...
// Nos conectamos a la base de datos
	  ...
	  $query = "INSERT INTO Usuarios(Usuario,Contrasena,Nombre,Ap_paterno,Ap_materno,Genero,Correo_electronico,Fecha_nacimiento,idTipo) VALUES ('$usuario', '$contrasena', '$nombre','$ap_paterno', '$ap_materno', '$genero', '$correo_electronico', '$fecha_nacimiento', '2')";
 ...
 //Volvemos a la pagina principal
	header("Location: http://antares.dci.uia.mx/ic15jcr/Final/login.html");
